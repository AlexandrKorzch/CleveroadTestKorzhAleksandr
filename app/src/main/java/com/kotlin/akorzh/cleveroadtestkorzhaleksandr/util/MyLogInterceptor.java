...
import static com.kotlin.akorzh.cleveroadtestkorzhaleksandr.global.Const.MY_LOG;
...
public class MyLogInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if(level == Level.NONE) {
            ...
            this.logger.log("");
            this.logger.log("<-- " + var31.code() + ' ' + var31.message() + ' '
                    + var31.request().url() + " (" + var33 + "ms" + (!logHeaders?", "
                    + bodySize + " body":"") + ')');
